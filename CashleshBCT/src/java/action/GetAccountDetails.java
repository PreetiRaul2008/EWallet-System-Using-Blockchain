...
public class GetAccountDetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "SELECT * FROM tbl_account_details WHERE account_holder='" + email + "'";
            DBConnection db = new DBConnection();
            ResultSet rs = db.select(sql);
            if (rs.next()) {
                json.put("account_no", aes.decrypt(rs.getString("account_no")));
                json.put("balance", rs.getString("balance"));
                json.put("address", aes.decrypt(rs.getString("bank_address")));
                json.put("bank_name", aes.decrypt(rs.getString("bank_name")));
                json.put("status", rs.getString("account_status"));
                json.put("bank_id", aes.decrypt(rs.getString("bank_id")));
